...
const Coursebar = ({
  ...
  return (
    <div className="w-[400px] h-screen z-50 fixed left-0 bg-white border-r-[1px] overflow-y-auto">
      ...
      {filter.map(({ heading, state, setState, buttonName }) => (
        <div
          key={heading}
          className="grid-inline mb-[20px] pb-[15px] pl-[40px] mr-[40px] border-b-[1px]"
        >
