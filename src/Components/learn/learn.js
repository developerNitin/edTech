  ...
  return (
    <div className="w-full">
      ...
      <div className={`flex h-screen ${videoNav && "mr-[350px]"} `}>
        <div className={`flex-1 pt-[60px] ${videoNav && "border-r-[1px]"}`}>
          ...
          >
            <video
              ...
              type="video/mp4"
              controls
              onLoadedMetadata={(e) => setVideoLength(e.target.duration.toFixed(2))}
            />
          </div>
          <div className="">
        ...
        >
          <button
            className="bg-[#1C1D1F] hover:bg-[#353739] text-white mr-[-128px] hover:mr-0 p-[8px] flex items-center border border-[#6a6f73] border-r-0"
            onClick={() => setVideoNav(true)}
          >
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="flex gap-[5px] text-[14px]">
                            {i.video + IDX === toggleLink && videoLength} <PlayFill />
                          </span>
                        </div>
                      </button>
                    );
